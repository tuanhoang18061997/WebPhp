...
<div class="wrapper">
    ...
    <div class="widgets">
        ...
        <div class="oneTwo">
            <div class="widget">
                <div class="title">
                    <img src="<?php echo public_url()?>admin/<?php echo public_url()?>admin/images/icons/dark/money.png" class="titleIcon">
                    <h6>Doanh số</h6>
                </div>
        ...
        <div class="oneTwo">
            <div class="widget">
                <div class="title">
                    <img src="<?php echo public_url()?>admin/<?php echo public_url()?>admin/images/icons/dark/users.png" class="titleIcon">
        ...
        <div class="widget">
            ...
            <table class="sTable mTable myTable" id="checkAll" width="100%" cellspacing="0" cellpadding="0">
                ...
                <thead>
                    <tr>
                        <td style="width:10px;"><img src="<?php echo public_url()?>admin/<?php echo public_url()?>admin/images/icons/tableArrows.png"></td>
