...
<div class="box-right">
    ...
    <div class="content-box">
        ...
        <div class="support">
            ...
            <p>
                <img style="margin-bottom:-3px" src="<?php echo public_url()?>site/images/phone.png"> 0966117765 </p>

            <p>
                <a rel="nofollow" href="mailto:hoangvantuyencnt@gmail.com">
                    <img style="margin-bottom:-3px" src="<?php echo public_url()?>site/images/email.png"> Email: tuanhoang18061997@gmail..
                </a>
            </p>
            <p>
                <a rel="nofollow" href="skype:tuyencnt90">
                    <img style="margin-bottom:-3px" src="<?php echo public_url()?>site/images/skype.png"> facebook: minhtuanIT1518 </a>
            </p>
        </div>
    </div>
</div>
    ...
    <div class="content-box">
        <center>
            ...
            <a href="http://www.histats.com" target="_blank" title="hit counter">
                ...
                <div id="histats_counter_4666" style="display: block;"><a href="http://www.histats.com/viewstats/?sid=2138481&amp;ccid=401" target="_blank"><canvas id="histats_counter_4666_canvas" width="119" height="81"></canvas></a></div>
            </a>
