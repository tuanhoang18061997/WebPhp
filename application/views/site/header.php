...
<div class="top">
    ...
    <div id="logo">
        ...
        <a href="" title="Học lập trình website với PHP và MYSQL">
            <img src="<?php echo public_url()?>site/images/logo.png" style="height:100px ;transform: translatex(-40px);max-width:1000%" alt="Học lập trình website với PHP và MYSQL">
        </a>
    </div><!-- End logo -->
    ...
    <div id="cart_expand" class="cart">
        ...
        <img src="<?php echo public_url()?>site/images/cart.png">
    </div>
    
    <div id="search">
        <!-- the search -->
        <form method="get"  action="tim-kiem.html">
            <input type="text" id="text-search" name="key-search" value="" placeholder="Tìm kiếm sản phẩm..." class="ui-autocomplete-input form-control" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true">
            <input type="submit" class="btn btn-success"  name="but" value="Tìm kiếm">
        </form>
    </div><!-- End search -->
...
<div id="menu">
    <!-- the menu -->
    <ul class="menu_top multi-level animated-2s fadeInUpHalf">
